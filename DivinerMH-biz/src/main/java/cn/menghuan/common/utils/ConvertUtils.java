package cn.menghuan.common.utils;

import cn.menghuan.common.constants.CommonConstant;
import cn.menghuan.common.constants.SymbolConstant;
...
//					FieldDTO fieldDTO = new FieldDTO(annotation.fileName(), field.getName(), o,annotation.valueType(), annotation.order(), annotation.type());
...
//								if(annotation1!=null){
//									headInfoDTOS.add(new HeadInfoDTO(annotation1.order(),annotation1.fileName(),field1.getName(),annotation1.valueType()));
//								}
//							}
