...
-- ----------------------------
BEGIN;
INSERT INTO `tb_log` VALUES (87, 'tycoding', '新增文章', 1, 'cn.menghuan.blog.controller.ArticleController.add()', ' sysArticle\"SysArticle(id=14, title=1, author=tycoding, des=1, content=1, create...', '127.0.0.1', '2020-06-28 23:07:41', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (88, 'tycoding', '更新文章', 1, 'cn.menghuan.blog.controller.ArticleController.update()', ' sysArticle\"SysArticle(id=14, title=123, author=tycoding, des=1, content=1, crea...', '127.0.0.1', '2020-06-28 23:07:55', '内网IP|0|0|内网IP|内网IP');
COMMIT;
